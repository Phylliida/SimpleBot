...
cd "$(dirname "$0")"
nix-shell -p  llama-cpp-vulkan --run 'llama-server -m ../../models/GLM-ablated-aware-Q4_K_S.gguf --ignore-eos --jinja --chat-template "message.content" --ctx-size 12000 --temp 1 --top-k 0 --top-p 1 --min-p 0 --port 8057 --gpu-layers 999 --host 0.0.0.0'
